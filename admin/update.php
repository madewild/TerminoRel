...
echo '<td><input type="text" class="input" id="term" name="term" value="' . $row['termtext'] . '"></td></tr>';

$variant = $row['variant'];
$mf = False;
if($variant != NULL) {
    echo "<tr><td><label for='variant'>Variante</label></td>";
    echo '<td><input type="text" class="input" id="variant" name="variant" value="' . $variant . '"></td></tr>';
    $mf = True;
}
...
if($row2) {
    ...
    echo '<td><input type="text" class="input" id="abrev" name="abrev" value="' . $acro . '"></td></tr>';
}
...
echo '<td><input type="text" class="input" id="catgram" name="catgram" value="' . $pos . '"></td></tr>';
...
echo '<td><input type="text" class="input" id="gender" name="gender" value="' . $gender . '"></td></tr>';
...
echo '<td><input type="text" class="input" id="number" name="number" value="' . $number . '"></td></tr>';
...
if(!empty($definition)) {
    ...
    echo '<td><input type="text" class="input" id="def" name="def" value="' . $definition . '"></td></tr>';
    echo "<tr><td><label for='sourcedef'>Source de la définition</label></td>";
    echo '<td><input type="text" class="input" id="sourcedef" name="sourcedef" value="' . $bib_title_def . ", " . $source_text_def . '"></td></tr>';
}
...
if(!empty($explanation)) {
    ...
    echo '<td><input type="text" class="input" id="exp" name="exp" value="' . $explanation . '"></td></tr>';
    echo "<tr><td><label for='sourceexp'>Source de l'explication</label></td>";
    echo '<td><input type="text" class="input" id="sourceexp" name="sourceexp" value="' . $bib_title_exp . ", " . $source_text_exp . '"></td></tr>';
}
echo "</table>";
