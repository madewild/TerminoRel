...
echo '<td><input type="text" class="input" id="term" name="term" value="' . $row['termtext'] . '" size="200"></td></tr>';

$variant = $row['variant'];
$mf = False;
if($variant != NULL) {
    echo "<tr><td><label for='variant'>Variante</label></td>";
    echo '<td><input type="text" class="input" id="variant" name="variant" value="' . $variant . '" size="200"></td></tr>';
    $mf = True;
}
...
if($row2) {
    ...
    echo '<td><input type="text" class="input" id="abrev" name="abrev" value="' . $acro . '" size="200"></td></tr>';
}
...
echo '<td><input type="text" class="input" id="catgram" name="catgram" value="' . $pos . '" size="200"></td></tr>';
...
echo '<td><input type="text" class="input" id="gender" name="gender" value="' . $gender . '" size="200"></td></tr>';
...
echo '<td><input type="text" class="input" id="number" name="number" value="' . $number . '" size="200"></td></tr>';
...
if(!empty($definition)) {
    ...
    echo '<td><input type="text" class="input" id="def" name="def" value="' . $definition . '" size="200"></td></tr>';
    echo "<tr><td><label for='sourcedef'>Source de la définition</label></td>";
    echo '<td><input type="text" class="input" id="sourcedef" name="sourcedef" value="' . $bib_title_def . ", " . $source_text_def . '" size="200"></td></tr>';
}
...
if(!empty($explanation)) {
    ...
    echo '<td><input type="text" class="input" id="exp" name="exp" value="' . $explanation . '" size="200"></td></tr>';
    echo "<tr><td><label for='sourceexp'>Source de l'explication</label></td>";
    echo '<td><input type="text" class="input" id="sourceexp" name="sourceexp" value="' . $bib_title_exp . ", " . $source_text_exp . '" size="200"></td></tr>';
}
echo "</table>";
